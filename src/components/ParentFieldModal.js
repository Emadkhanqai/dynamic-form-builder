  ...
  useEffect(() => {
    const loadLookupData = async () => {
      ...
      try {
        ...
        const codes = await apiService.getLookupData(
  ...
  return (
    <Modal show={show} onHide={onHide} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>
          {isNew ? "Add Parent Field" : "Edit Parent Field"}
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm={8}>
              ...
              <Form.Text className="text-muted">
                This is unique code used for rendering title on front-end.
              </Form.Text>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm={8}>
              <Form.Control
                         ...
                         />
              <Form.Text className="text-muted">
                You can set it manually or by arrow buttons.
              </Form.Text>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm={8}>
              <Form.Check
                ...
                onChange={(e) =>
                  handleChange("allowSubmission", e.target.checked)
                }
              />
              <Form.Text className="text-muted">
                This displays submit button on bottom of the page.{" "}
              </Form.Text>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm={8}>
              <Form.Control
                ...
                onChange={(e) =>
                  handleChange("pageButtonTitle", e.target.value)
                }
              />
              <Form.Text className="text-muted">
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm={8}>
              ...
              />
              <Form.Text className="text-muted">
                This displays page title on starting of the page.
              </Form.Text>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm={8}>
              ...
              />
              <Form.Text className="text-muted">
                It render page break after this parent.{" "}
              </Form.Text>
            </Col>
          </Form.Group>
